  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Administración del Sistema</h1>
        ...
        <div className="card-body">
          <div className="flex space-x-1 bg-gray-100 p-1 rounded-xl">
            {tabs.map((tabItem) => (
              <button
                key={tabItem.id}
                onClick={() => setTab(tabItem.id as 'usuarios' | 'roles')}
      ...
      <div className="transition-all duration-300">
        {tab === 'usuarios' ? <Usuarios /> : <RolesAdmin />}
      </div>
    </div>
  );
};
